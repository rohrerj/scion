...
go test -bench=. ./go/coligate/processing -run="^#" -count 5 > benchmarks.txt
echo "Start performance measurements with payload size of 200 bytes"
mkdir "export/200"
while ! (./scion.sh stop ; rm gen-cache/* ; ./scion.sh start ; sleep 5 ; ./bin/coligate_performance -pktSize 200)
do
    echo "retry"
done
./scion.sh stop
...
while ! (./scion.sh stop ; rm gen-cache/* ; ./scion.sh start ; sleep 5 ; ./bin/coligate_performance -pktSize 500)
do
    echo "retry"
done
./scion.sh stop
...
while ! (./scion.sh stop ; rm gen-cache/* ; ./scion.sh start ; sleep 5 ; ./bin/coligate_performance -pktSize 1000)
do
    echo "retry"
done
./scion.sh stop
...
while ! (./scion.sh stop ; rm gen-cache/* ; ./scion.sh start ; sleep 5 ; ./bin/coligate_performance -pktSize 5000)
do
    echo "retry"
done
./scion.sh stop
